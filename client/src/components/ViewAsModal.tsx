...
export default function ViewAsModal({ userId, onClose }: ViewAsProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg border border-gray-200 w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between rounded-t-lg z-10">
          <div>
        ...
        <div className="sticky bottom-0 bg-white border-t border-gray-100 px-6 py-3 flex justify-end rounded-b-lg">
          <button onClick={onClose} className="text-sm bg-gray-900 text-white px-4 py-2 rounded hover:bg-gray-800">Close</button>
        </div>
      </div>
    </div>
  );
